...
$query = "select calificacion, nombre from entidad ";
 ...
 <html>  
          ...
          //$bus=$_POST['id'];
           ...
           {  
                var data = google.visualization.arrayToDataTable([  
                          ...
                          {  
                              echo "['".$row["nombre"]."', ".$row["calificacion"]."]," ;   
                          }  
                          ?>  
                     ]);  
                ...
                var options = {  
                      title: 'GRAFICA DE LOS RESTAURANTES MEJOR CALIFICADOS', titleTextStyle: {color: '##1E0BAE'},  
                      //is3D:true,  
                      pieHole: 0.4  
                     };  
      ...
      <body>  
           ...
           <div style="width:900px;">  
                <h3 align="center" id="Titulo2"> Grafica de Dona de los restaurantes mejor evaluados en Gluzzer</h3>  
                <br />  
