...
namespace proyectoFruteria.Vista
{
    public partial class EditarProducto : Form
    {
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            objVariables.idProductos = Int32.Parse(txtId.Text);
            ...
            objVariables.fechaAdquirido = DateTime.Parse(dtmFecha.Text);

            objConexion.EditarPro(objVariables);
                MessageBox.Show("Producto Modificado", "Editar", MessageBoxButtons.OK, MessageBoxIcon.Information);
                this.Close();
